export default {
  ...
  menu: {
    ...
    scanTextures: 'Scan unindexed textures',
    save: 'Save',
    undo: 'Undo',
    redo: 'Redo',
  ...
  spriteImport: {
    ...
    scanTitle: 'Scan project textures',
    scanDescription: 'Found {count} unindexed PNG images under the project textures folder.',
    scanDestination:
      'The existing image files will be scanned and added to Sprite Tables. Nothing will be copied.',
    scanConfirm: 'Scan {count} images',
    scanSuccess: 'Scanned {count} textures.',
    scanSuccessDescription: 'Sprite Table manifests were added to the project.',
  ...
  style: {
    ...
    project: 'Project',
    system: 'System',
    fontHint: 'Select a project font or enter a font name.',
    loadSystemFonts: 'Read system fonts',
    loadingSystemFonts: 'Reading…',
    systemFontsUnsupported: 'This browser does not support system font access.',
    fontDiagnostics: 'Project font diagnostics',
    projectFont: 'Project font',
    manualFont: 'Select font',
    fontSize: 'Size',
    ...
    templateNameConflictTitle: 'Template name already in use',
    templateNameConflict: '“{name}” is already used by another font style. Overwrite it instead?',
  ...
  build: {
    ...
    confirmTitle: 'Build textures',
    confirmMessage: 'Are you sure you want to export?',
    exportType: 'Export type',
    allTextures: 'All textures',
    allTexturesDescription: 'Include all {count} textures.',
    translatedTextures: 'Translated textures',
    translatedTexturesDescription: 'Include {count} textures with translation regions.',
    overwriteType: 'Overwrite type',
    changedOnly: 'Only changed textures',
    changedOnlyDescription: 'Export {count} missing or edited textures.',
    overwriteAll: 'Overwrite all',
    overwriteAllDescription: 'Rebuild all {count} selected textures.',
  },
  spriteTable: {
    textures: 'Textures',
    sprites: 'Sprites',
  ...
  spriteGrid: {
    ...
    batchTranslate: 'Mark for translation',
    batchTranslateSuccess: 'Marked {count} sprites for translation',
    batchUntranslateSuccess: 'Marked {count} sprites as not needing translation',
    clearSelection: 'Clear selection',
    selectSprite: 'Select {name}',
  ...
  sprite: {
    ...
    multipleSelected: '{count} sprites selected',
    multipleSelectedHint: 'Details are hidden for multiple selection.',
    batchTranslationConfirmTitle: 'Change translation status',
    batchTranslationConfirm: 'Change {count} selected sprites to “{state}”?',
    needsTranslation: 'Needs translation',
    noTranslation: 'Does not need translation',
    frame: 'Frame',
    rotation: 'Rotation',
    trimmed: 'Trimmed',
  ...
  status: {
    ...
    openingProgress: 'Opening project {completed}/{total}…',
  ...
  errors: {
    ...
    spriteImport: {
      ...
      noUnindexedTextures: 'No unindexed PNG textures were found.',
    },
