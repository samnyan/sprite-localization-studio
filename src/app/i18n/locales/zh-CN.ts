export default {
  ...
  spriteImport: {
    ...
    scanTitle: '扫描工程贴图',
    scanDescription: '在工程 textures 文件夹下发现 {count} 张未索引 PNG 图片。',
    scanDestination: '将扫描现有图片并添加 Sprite Table，不会复制图片文件。',
    scanConfirm: '扫描 {count} 张图片',
    scanSuccess: '已扫描 {count} 张贴图。',
    scanSuccessDescription: 'Sprite Table manifest 已添加到工程。',
  ...
  style: {
    ...
    project: '项目',
    system: '系统',
    fontHint: '选择项目字体或手动输入字体名。',
    loadSystemFonts: '读取系统字体',
    loadingSystemFonts: '读取中…',
    systemFontsUnsupported: '当前浏览器不支持读取系统字体。',
  ...
  build: {
    ...
    confirmTitle: '构造贴图',
    confirmMessage: '确定要导出吗？',
    exportType: '导出类型',
    allTextures: '所有贴图',
    allTexturesDescription: '包含全部 {count} 张贴图。',
    translatedTextures: '翻译贴图',
    translatedTexturesDescription: '只包含有翻译区域的 {count} 张贴图。',
    overwriteType: '覆盖类型',
    changedOnly: '只导出已变更贴图',
    changedOnlyDescription: '导出缺失或已修改的 {count} 张贴图。',
    overwriteAll: '全部覆盖导出',
    overwriteAllDescription: '重新构造所选的 {count} 张贴图。',
  },
  spriteTable: {
    textures: '贴图',
    sprites: 'Sprites',
  ...
  spriteGrid: {
    ...
    batchTranslate: '批量标记为需要翻译',
    batchTranslateSuccess: '已将 {count} 张图片标记为需要翻译',
    batchUntranslateSuccess: '已将 {count} 张图片标记为不需要翻译',
    clearSelection: '清除选择',
    selectSprite: '选择 {name}',
  ...
  sprite: {
    ...
    texture: '贴图',
    translate: '需要翻译',
    multipleSelected: '已选择 {count} 张贴图',
    multipleSelectedHint: '多选时隐藏详细属性。',
    batchTranslationConfirmTitle: '修改翻译状态',
    batchTranslationConfirm: '确定将所选 {count} 张贴图改为“{state}”吗？',
  ...
  status: {
    ...
    openingProgress: '正在打开工程 {completed}/{total}…',
    building: '正在构造贴图…',
  ...
  errors: {
    ...
    spriteImport: {
      ...
      noUnindexedTextures: '没有找到未索引的 PNG 贴图。',
    },
